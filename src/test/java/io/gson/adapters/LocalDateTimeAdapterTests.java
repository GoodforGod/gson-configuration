 ...
 * @since 26.04.2021
 */
class LocalDateTimeAdapterTests extends Assertions {
    ...
    private final Gson adapterCustom = new GsonBuilder()
            .registerTypeAdapter(LocalDateTime.class, new LocalDateTimeAdapter(DateTimeFormatter.ofPattern(CUSTOM_ISO)))
            .create();
