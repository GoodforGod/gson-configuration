...
class LocalTimeDeserializerTests extends Assertions {
  ...
  private final Gson adapterCustom =
      new GsonBuilder()
          .registerTypeAdapter(
              LocalTime.class, new LocalTimeSerializer(DateTimeFormatter.ofPattern(CUSTOM_ISO)))
          .registerTypeAdapter(
              LocalTime.class, new LocalTimeDeserializer(DateTimeFormatter.ofPattern(CUSTOM_ISO)))
          .create();
