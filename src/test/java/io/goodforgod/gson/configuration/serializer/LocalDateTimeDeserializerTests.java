...
class LocalDateTimeDeserializerTests extends Assertions {
  ...
  private static final LocalDateTime VALUE_TIME =
  ...
  private final Gson adapterCustom =
      new GsonBuilder()
          .registerTypeAdapter(
              LocalDateTime.class,
              new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(CUSTOM_ISO)))
          .registerTypeAdapter(
              LocalDateTime.class,
              new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(CUSTOM_ISO)))
          .create();
